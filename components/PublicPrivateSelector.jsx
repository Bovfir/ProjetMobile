...
export default function PublicPrivateSelector ({selectedType, onSelectedType, styles}){
    return(
        <View style={styles.containerPublicPrivate}>
            ...
            <Pressable style={[styles.viewPublic, !selectedType && styles.selectedBackgroundType]}
            ...
            <Pressable style={[styles.viewPrivate, selectedType && styles.selectedBackgroundType]}
